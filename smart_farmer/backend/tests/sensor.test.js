    ...
    it("Should return sensors", async () => {
      ...
      it("Should return ports", async () => {
        const res = await request(baseURL).get(
          "/api/modules/get-ports"
        );
        console.log(res.body);
        expect(res.status).toEqual(200);
        expect(res.body.Temp_Sensors[0]).toEqual("6363a46d57669fe158501664-2000");
        expect(res.body.Humidity_Sensors[0]).toEqual("6363a46d57669fe158501664-3000");
        expect(res.body.RainFall_Sensors[0]).toEqual("6363a46d57669fe158501664-4000");
      });
