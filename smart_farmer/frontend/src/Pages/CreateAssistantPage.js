...
export default function CreateAssistantPage() {
    ...
    const assistant_components = assistants.map((assistant)=><div className="col mb-2 h-100" key={assistant._id}><AssistantCard id={assistant._id} name={assistant.first_name+" "+assistant.second_name} location={assistant.location} email={assistant.email} profile_pic={assistant.profile_picture} assistants={assistants} setAssistants={setAssistants}></AssistantCard></div>)
                ...
                <div className="row">
                    <div className="col-12 col-lg-6 col-sm-10 ">
                        <Input formName='Create Assitant Account'>
                            <CreateAssistant assistants={assistants} setAssistants={setAssistants} />
                        </Input>
                    </div>
                </div>
