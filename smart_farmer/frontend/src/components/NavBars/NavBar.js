    ...
    return(
        <header className="">
            <nav className="navbar navbar-expand-md">
                ...
                <div class="collapse navbar-collapse ul-bg" id="navbarNavDropdown">
                    <ul className="navbar-nav ms-auto">
                        <li className="nav-item ms-auto">
                            <Link className="nav-link mx-3 fs-5" style={{textDecoration: 'none'}} to="/user/viewProfilePage">
                                Profile
                            </Link>
                        </li>
                        <li className="nav-item ms-auto">
                        ...
                        <li className="nav-item ms-auto">
                            <Link className="nav-link mx-3 fs-5" style={{textDecoration: 'none'}} to="/user/home">
                                Home
                            </Link>
                        </li>
                    </ul>
