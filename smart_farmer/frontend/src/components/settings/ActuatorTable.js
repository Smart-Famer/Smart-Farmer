          ...
          <tr>
            ...
            <td>
              <button
                ...
                onClick={() => {
                  deleteModule("Camera", actuator._id);
                }}
              >
            ...
            <td>
              <button
                ...
                onClick={() => {
                  navigate(
                    `/user/farm/Modules/edit-actuator/Camera/${actuator._id}`
                  );
                }}
              >
          ...
          <tr>
            ...
            <td>
              <button
                className="btn btn-sm btn-danger"
                onClick={() => {
                  deleteModule("Pump", actuator._id);
                }}
              >
                <i className="bi-trash3"></i>
              </button>
            ...
            <td>
              <button
                ...
                onClick={() => {
                  navigate(
                    `/user/farm/Modules/edit-actuator/Pump/${actuator._id}`
                  );
                }}
              >
                <i className="bi-pencil"></i>
