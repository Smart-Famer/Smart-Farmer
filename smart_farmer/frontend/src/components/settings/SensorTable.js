          ...
          <tr>
            ...
            <td>
              <button
                ...
                onClick={() => {
                  deleteModule("Temperature", sensor._id);
                }}
              >
            ...
            <td>
              <button
                ...
                onClick={() => {
                  navigate(
                    `/user/farm/Modules/edit-sensor/Temperature/${sensor._id}`
                  );
                }}
              >
          ...
          <tr>
            ...
            <td>
              <button
                ...
                onClick={() => {
                  navigate(
                    `/user/farm/Modules/edit-sensor/Rainfall/${sensor._id}`
                  );
                }}
              >
                <i className="bi-pencil"></i>
          ...
          <tr>
            ...
            <td>
              <button
                className="btn btn-sm btn-danger"
                onClick={() => {
                  deleteModule("Humidity", sensor._id);
                }}
              >
                <i className="bi-trash3"></i>
              </button>
            ...
            <td>
              <button
                ...
                onClick={() => {
                  navigate(
                    `/user/farm/Modules/edit-sensor/Humidity/${sensor._id}`
                  );
                }}
              >
                <i className="bi-pencil"></i>
          ...
          <tr>
            ...
            <td>
              <button
                className="btn btn-sm btn-primary"
                onClick={() => {
                  navigate(`/user/farm/Modules/edit-sensor/Soil/${sensor._id}`);
                }}
              >
                <i className="bi-pencil"></i>
              </button>
